...
- Implementation screenshot: `/tmp/zx-large-modules.png`.
- Combined comparison: `/tmp/zx-large-modules-comparison.jpg`.
...
- Module buttons should be larger, and the explanatory sentence below them should be removed.
...
- Spacing and layout rhythm: module pills are 53.6 px high with larger type and padding, wrap cleanly at 1280 px, and only one focused chart is rendered at a time.
...
5. Post-fix evidence: `/tmp/zx-large-modules.png` and browser interaction checks confirm the larger controls, focused module behavior, and matching owner colors.
