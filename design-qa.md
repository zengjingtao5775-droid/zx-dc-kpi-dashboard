...
- Implementation screenshot: `/tmp/zx-six-modules.png`.
...
5. Post-fix evidence: `/tmp/zx-six-modules.png` and browser interaction checks confirm the focused module behavior and matching owner colors.
